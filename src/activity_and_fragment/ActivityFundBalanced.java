...
public class ActivityFundBalanced extends FragmentActivity implements
		ActionBar.TabListener {

	// Global variables for tabs generation
	private ViewPager viewPager;
	private AdapterTBFTabs pagerAdapter;
	...
	public void initializeActionBar() {
		...
		pagerAdapter = new AdapterTBFTabs(getSupportFragmentManager());
