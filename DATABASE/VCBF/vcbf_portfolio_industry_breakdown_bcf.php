  ...
  { 
	...
	for ($i = 0; $i < $total_sheets; $i++)
	{
		...
		foreach ($arraydata as $row)
		{
			...
			$update = false;
			$r_sql = "select * from vcbf_portfolio_industry_breakdown_bcf";
			...
			if ($update ==  true)
			{
				$sql = "UPDATE vcbf_portfolio_industry_breakdown_bcf SET percentage = " . $percentage . " WHERE date = '" . $date . "' and (industry = 
			...
			{
				$sql = "INSERT INTO vcbf_portfolio_industry_breakdown_bcf VALUES ('" . $date . "', '" . $industry . "' , '" . $industry_vn . "' ,
					" . $percentage . ")";
