  ...
  { 
	...
	for ($i = 0; $i < $total_sheets; $i++)
	{
		...
		foreach ($arraydata as $row)
		{
			...
			$update = false;
			$r_sql = "select * from vcbf_portfolio_top_holding_tbf";
			...
			if ($update ==  true)
			{
				$sql = "UPDATE vcbf_portfolio_top_holding_tbf SET percentage = " . $percentage . " WHERE date = '" . $date . "' and (company_name = '"
			...
			{
				$sql = "INSERT INTO vcbf_portfolio_top_holding_tbf VALUES ('" . $date . "', '" . $company_name . "', '" . $company_name_vn . "' ,
					" . $percentage . ")";
