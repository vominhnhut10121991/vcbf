  ...
  { 
	...
	for ($i = 0; $i < $total_sheets; $i++)
	{
		...
		foreach ($arraydata as $row)
		{
			...
			$update = false;
			$r_sql = "select * from vcbf_portfolio_statistic_tbf";
			...
			if ($update ==  true)
			{
				$sql = "UPDATE vcbf_portfolio_statistic_tbf SET net_asset_value = " . $net_asset_value . ", turnover_rate = " . $turnover_rate . ", 
			...
			{
				$sql = "INSERT INTO vcbf_portfolio_statistic_tbf VALUES ('" . $date . "'," . $net_asset_value . "," . $turnover_rate . ",
					" . $total_position . ")";
