  ...
  { 
	...
	for ($i = 0; $i < $total_sheets; $i++)
	{
		...
		foreach ($arraydata as $row)
		{
			...
			$update = false;
			$r_sql = "select * from vcbf_portfolio_detail_bcf";
			...
			if ($update ==  true)
			{
				$sql = "UPDATE vcbf_portfolio_detail_bcf SET percentage = " . $percentage . " WHERE date = '" . $date . "' and (asset = '" . $asset . "' 
			...
			{
				$sql = "INSERT INTO vcbf_portfolio_detail_bcf VALUES ('" . $date . "', '" . $asset . "', '" . $asset_vn . "', " . $percentage . ")";
