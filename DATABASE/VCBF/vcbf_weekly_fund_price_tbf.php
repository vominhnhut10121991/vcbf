  ...
  { 
	...
	for ($i = 0; $i < $total_sheets; $i++)
	{
		...
		foreach ($arraydata as $row)
		{
			...
			$update = false;
			$r_sql = "select * from vcbf_weekly_fund_price_tbf";
			...
			if ($update ==  true)
			{
				$sql = "UPDATE vcbf_weekly_fund_price_tbf SET nav_unit = " . $nav_unit . ", nav_change = " . $nav_change . ", pop = " . $pop . ", 
			...
			{
				$sql = "INSERT INTO vcbf_weekly_fund_price_tbf VALUES ('" . $date . "'," . $nav_unit . " ," . $nav_change . "," . $pop . " ,
